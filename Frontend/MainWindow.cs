...
{	
	public MainWindow (): base (Gtk.WindowType.Toplevel)
	{
		...
		//New Map button
		Widget mapWidget = OperationWidget.CreateOperationWidget ("Assets/newfileicon.png", "New Sale");
		mapWidget.Show ();
		...
		//Save button
		Widget saveWidget = OperationWidget.CreateOperationWidget ("Assets/saveicon.png", "Save Sale");
		saveWidget.Show ();
		...
		//New Stand button
		Widget newStandWidget = OperationWidget.CreateOperationWidget ("Assets/addstandicon.png", "New Stand");
		newStandWidget.Show ();
		...
		//Rotate button
		Widget rotateWidget = OperationWidget.CreateOperationWidget ("Assets/rotateicon.png", "Rotate Stand 90°");
		rotateWidget.Show ();
		...
		*/
		...
		//Insert Grid
		CairoGraphic.draw ();  //draws the grid to an image file for now.  This will probably change once core is hooked up.
